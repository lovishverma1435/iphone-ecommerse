                        ...
                        <div className="grid grid-cols-4 gap-x-[30px] gap-y-[60px] pt-[60px]">
                        {
                            data.map((item,index) => (
                                <div key={index + Date.now() + item}>
                                    {
                                        <Explore image={item.image} colgroup={clr} wishlist={item.wishlist} view={item.view} name={item.name} price={item.price} ratting={item.ratting} review={item.review} topnew={item.topnew}/>
                                    }
                                </div>
                            ))
                        }</div>
