...
const JblSpeaker = () => {
    return (
        <section className='container mt-[140px]'>
            <div className="flex bg-black_1-black  mb-[71px]">
                <div className="flex  items-center justify-between p-[50px]">
                    <div className="flex flex-col max-w-[443px] items-start gap-[35px]">
                        ...
                        <h2 className='text-white_1-white font-i font-semibold text-5xl leading-[60px] tracking-wide'>Enhance Your Music Experience</h2>
